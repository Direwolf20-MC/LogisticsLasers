...
public class ModBlocks {
    ...
    public static final RegistryObject<ContainerType<PolyFilterContainer>> POLY_FILTER_CONTAINER = CONTAINERS.register("poly_filter_container", () -> IForgeContainerType.create(PolyFilterContainer::new));
