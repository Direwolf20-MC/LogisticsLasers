...
public class PolyFilterContainer extends Container {
    ...
    public PolyFilterContainer(@Nullable ContainerType<?> type, @Nullable ItemStack card, int windowId, PlayerInventory playerInventory, ItemStackHandler handler, BlockPos sourcePos, IIntArray cardData) {
        super(type, windowId);
    ...
    public PolyFilterContainer(@Nullable ItemStack card, int windowId, PlayerInventory playerInventory, ItemStackHandler handler, BlockPos sourcePos, IIntArray cardData) {
        super(ModBlocks.POLY_FILTER_CONTAINER.get(), windowId);
        this.handler = handler;
        this.filterItemStack = card;
        this.setup(playerInventory);
        this.sourceContainer = sourcePos;
